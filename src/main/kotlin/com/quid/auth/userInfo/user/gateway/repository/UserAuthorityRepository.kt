package com.quid.auth.userInfo.user.gateway.repository

import com.quid.auth.userInfo.user.domain.UserAuthority
import com.quid.auth.userInfo.user.gateway.repository.jpa.UserAuthorityEntity
import com.quid.auth.userInfo.user.gateway.repository.jpa.UserAuthorityJpaRepository
import com.quid.auth.userInfo.user.gateway.repository.redis.UserAuthorityRedisRepository
