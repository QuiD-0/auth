package com.quid.auth.userInfo.user.gateway.web
...
import com.quid.auth.userInfo.user.gateway.web.request.GrantAuthorityRequest
import com.quid.auth.userInfo.user.gateway.web.request.RevokeAuthorityRequest
import com.quid.auth.userInfo.user.gateway.web.response.UserDetailResponse
import com.quid.auth.userInfo.user.usecase.FindAdmin
import com.quid.auth.userInfo.user.usecase.GrantAuthority
import com.quid.auth.userInfo.user.usecase.RevokeAuthority
    ...
    fun grantUserAuthority(@RequestBody request: GrantAuthorityRequest): ApiResponse<String>  =
        request
            .run {
                grantAuthority(
                    this.userSeq,
                    com.quid.auth.userInfo.user.domain.AuthType.of(this.authority)
                )
            }
