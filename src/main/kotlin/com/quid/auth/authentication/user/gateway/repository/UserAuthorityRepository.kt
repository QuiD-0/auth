package com.quid.auth.authentication.user.gateway.repository

import com.quid.auth.authentication.user.domain.UserAuthority
import com.quid.auth.authentication.user.gateway.repository.jpa.UserAuthorityEntity
import com.quid.auth.authentication.user.gateway.repository.jpa.UserAuthorityJpaRepository
import com.quid.auth.authentication.user.gateway.repository.redis.UserAuthorityRedisRepository
